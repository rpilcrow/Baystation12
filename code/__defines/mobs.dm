...
#define SPECIES_WOOKIEE		"Wookiee"
#define SPECIES_TROLL		"Troll"
#define SPECIES_DARK		"Noctite"
...
#define RESTRICTED_SPECIES list(SPECIES_VOX, SPECIES_XENO, SPECIES_ALIEN, SPECIES_GOLEM, SPECIES_TROLL, SPECIES_WOOKIEE, SPECIES_DARK)
