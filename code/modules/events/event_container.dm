...
/datum/event_container/moderate
	...
	//	new /datum/event_meta(EVENT_LEVEL_MODERATE, "Grid Check",							/datum/event/grid_check, 				200,	list(ASSIGNMENT_ENGINEER = 10)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE,	"Psi Spasm",							/datum/event/minispasm,					30),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Bluespace Distortion",					/datum/event/bluespace_distortion,		100)
	)
