/datum/map/miningbrick
	allowed_jobs = list(/datum/job/captain, /datum/job/chief_engineer, /datum/job/doctor, /datum/job/hop, /datum/job/assistant, /datum/job/engineer) ///PIL_EDIT: removed datum/job/cyborg,
